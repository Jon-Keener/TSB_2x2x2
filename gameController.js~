        ...
        piece.addEventListener('mousedown', function(event) {
            ...
            if (hasIntervalStarted === false) {
                ...
                if (isNaN(parseInt(curHeldPieceStringPosition[3],10))) { // If the 4th digit is NaN then don't use it.
                    curHeldPieceStartingPosition = [ parseInt(curHeldPieceStringPosition[0],10)-1, parseInt(curHeldPieceStringPosition[1],10)-1, parseInt(curHeldPieceStringPosition[2],10)-1 ];
                } else {
...
function movePiece(piece, startingPosition, endingPosition) {
    ...
    if (boardPiece != '.') {
        ...
        curBoard[endingPosition[0]][endingPosition[1]][endingPosition[2]] = boardPiece; // move the boardPiece to the endingPosition
